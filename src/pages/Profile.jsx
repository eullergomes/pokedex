...
const Profile = ({ pokemonData }) => {
  ...
  const handleBackButtonClick = () => {
    navigate(-1); //back a page
  }

  return (
    <>
      <Navbar hideSearch handleBackButtonClick={handleBackButtonClick}/>
      <Container maxWidth="md">
        <Paper elevation={3}>
          <Box display="flex" flexDirection="column" alignItems="center" p={5}>
            <Typography fontWeight={600} variant="h4">{capitalize(name)}</Typography>
            <Box
              display="flex"
              alignItems="center"
              width="100%"
            ...
            <Box width="100%" >
              <Divider sx={{fontWeight: '600'}}>Variações</Divider>
              ...
              <Divider sx={{fontWeight: '600'}}>Ataques</Divider>
